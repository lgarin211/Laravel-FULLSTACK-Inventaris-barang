...
<head>
    ...
    <!-- Core css file -->
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/bootstrap.min.css">
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/fonts/line-icons.css">
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/animate.css">

    <!-- Plugins CSS file -->
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/slicknav.css">
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/owl.carousel.min.css">
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/owl.theme.css">

    <!-- Project css with  Responsive-->
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/main.css">
    <link rel="stylesheet" type="text/css" href="{{assets('/Tenpurēto')}}assets/css/responsive.css">
...
<body class="theme-cyan font-montserrat">
                ...
                <div class="row">
                    <div class="col-md-12 col-sm-12">
                        ...
                        <div class="img-thumb text-center wow fadeInUp" data-wow-delay="0.6s">
                            <img class="img-fluid" src="https://serviceware-se.com/fileadmin/user_upload/itfm.png"
                                alt="">
                        </div>
                    </div>
                </div>
    ...
    <div id="feature" class="section-padding" style="display: none !important;">
            ...
            <div class="row mb-5 vertical-content">
                ...
                <div class="col-lg-6 col-md-12">
                    <div class="mt-3 features_img wow fadeInRight" data-wow-delay="0.7s">
                        <div class="img_1"></div>
                        <img src="https://www.traveldatadaily.com/wp-content/uploads/2020/04/loyalty-fi-man.png" alt=""
    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        <path fill="#22252a" fill-opacity="1"
            d="M0,224L60,218.7C120,213,240,203,360,170.7C480,139,600,85,720,101.3C840,117,960,203,1080,218.7C1200,235,1320,181,1380,154.7L1440,128L1440,0L1380,0C1320,0,1200,0,1080,0C960,0,840,0,720,0C600,0,480,0,360,0C240,0,120,0,60,0L0,0Z">
        </path>
    </svg>
    <!-- Team Section Start -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-header text-center wow fadeInDown" data-wow-delay="0.3s">
                        ...
                        <p>APLIKASI INI DI KEMBANGKAN OLEH</p>
                    </div>
                </div>
            </div>
            <style>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="team-item text-center">
                        ...
                        <div class="info-text">
                            <h3><a href="#">Reksa Prayoga</a></h3>
                            <p>X~Rekayasa Perangkat Lunak 2~2021</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="team-item text-center">
                        ...
                        <div class="info-text">
                            <h3><a href="#">Dimas Surya Putra</a></h3>
                ...
                <div class="col-sm-6 col-md-6 col-lg-4">
                    <div class="team-item text-center">
                        <div class="team-img">
                            <img class="img-fluid" src="{{assets('/Tenpurēto')}}assets/img/20191002_145133.jpg" alt="">
                            <div class="team-overlay">
                                <div class="overlay-social-icon text-center">
                                    <ul class="social-icons">
                                        <li><a href="#"><i class="lni-facebook-filled" aria-hidden="true"></i></a></li>
    ...
    <section id="testimonial" class="testimonial section-padding" style="display: none !important;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div id="testimonials" class="owl-carousel wow fadeInUp" data-wow-delay="1.2s">
                        <div class="item">
                            <div class="testimonial-item d-flex">
                                <div class="img-thumb">
                                    <img src="{{assets('/Tenpurēto')}}assets/img/sm/avatar1.jpg" alt="">
                                </div>
                                <div class="content">
                                    ...
                                    <div class="info">
                                        ...
                                        <h3><a href="#">CEO & Founder @KigaFinance</a></h3>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="item">
                            <div class="testimonial-item d-flex">
                                <div class="img-thumb">
                                    <img src="{{assets('/Tenpurēto')}}assets/img/sm/avatar2.jpg" alt="">
                                </div>
                                <div class="content">
                                    <p class="description">Holisticly empower leveraged ROI whereas effective
                                        web-readiness. Completely enable emerging meta-services with cross-platform web
    ...
    <section id="pricing" class="section-padding" style="display: none !important;">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-header text-center wow fadeInDown" data-wow-delay="0.3s">
            ...
            <div class="row clearfix">
                    ...
                    <div class="card wow fadeInUp" data-wow-delay="0.3s">
                        <ul class="pricing card-body">
                            <li class="plan-img"><img class="img-fluid rounded-circle"
                                    src="../{{assets('/Tenpurēto')}}assets/images/plan-1.svg"></li>
                            <li class="price">
                ...
                <div class="col-lg-4 cool-md-4 col-sm-12">
                    <div class="card wow fadeInUp" data-wow-delay="0.7s">
                        <ul class="pricing card-body">
                            <li class="plan-img"><img class="img-fluid rounded-circle"
                                    src="../{{assets('/Tenpurēto')}}assets/images/plan-2.svg"></li>
                            <li class="price">
                ...
                <div class="col-lg-4 cool-md-4 col-sm-12">
                    <div class="card wow fadeInUp" data-wow-delay="1.0s">
                        <ul class="pricing card-body">
                            <li class="plan-img"><img class="img-fluid rounded-circle"
                                    src="../{{assets('/Tenpurēto')}}assets/images/plan-3.svg"></li>
                            <li class="price">
    ...
    <center>
        <div id="contact" class="cards card-1" style="width: 80%;height: 1000px;margin-bottom: 50px; display: none !important;">
            <h1 class="start">Want to get Started ?</h1>
            <div class="wrapper">
                <svg width="100%" height="200">
                    <defs>
                        <linearGradient id="rainbow-grad">
                            <stop offset="0" stop-color="#FF462C" />
                            <stop offset="14%" stop-color="#FFB700" />
                            <stop offset="28%" stop-color="#FFCD00" />
                            <stop offset="42%" stop-color="#36E74D" />
                            <stop offset="56%" stop-color="#593DFF" />
                            <stop offset="70%" stop-color="#B700DC" />
                            <stop offset="100%" stop-color="#FD006E" />
                        </linearGradient>

                        <filter id="rainbow-blur">
                            <feGaussianBlur in="SourceGrahic" stdDeviation="10" />
                        </filter>
                    </defs>

                    <text x="15%" y="150" filter="url(#rainbow-blur)" class="text-effect text_footer"> Want to get
                        started ?</text>
                    <text x="15%" y="150" class="text_footer">Want to get started ?</text>
                </svg>
            </div>
            ...
            <div class="core">
                <div class="bag_1">
                    <center>
                        <p class="one">Upgrade your back office, spend more time building. Your investors will thank
                            you.</p>
                        <p class="two" style="text-shadow: 2px 1px 3px pink;">Starting at $750 /month</p>
                        <input class="form-control form-control-lg" type="text" placeholder="Your Email"
                            style="border: 2px solid #34363a; margin-top:50px;">
                        <button class="btn btn-info"
                            style="border-radius:5px;width: 100%;height: 50px;font-weight: bold;">Enter !</button>
                    </center>
                </div>
                <div class="bag_2">
                    <center>
                        <p class="messagese"><i class="far fa-check-square"></i> Easy messaging, file sharing and
                            interaction with your Flow Accounting team</p>
                        <p class="messagese"><i class="far fa-check-square"></i> Easy messaging, file sharing and
                            interaction with your Flow Accounting team</p>
                        <p class="messagese"><i class="far fa-check-square"></i> Easy messaging, file sharing and
                            interaction with your Flow Accounting team</p>
    ...
    <div id="clients" class="section-padding" style="display: none !important;">
        <div class="container">
            <div class="row text-align-">
                <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="client-item-wrapper">
                        <img class="img-fluid" src="{{assets('/Tenpurēto')}}assets/img/clients/img1.png" alt="">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.6s">
                    <div class="client-item-wrapper">
                        <img class="img-fluid" src="{{assets('/Tenpurēto')}}assets/img/clients/img2.png" alt="">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="0.9s">
                    <div class="client-item-wrapper">
                        <img class="img-fluid" src="{{assets('/Tenpurēto')}}assets/img/clients/img3.png" alt="">
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-xs-12 wow fadeInUp" data-wow-delay="1.2s">
                    <div class="client-item-wrapper">
                        <img class="img-fluid" src="{{assets('/Tenpurēto')}}assets/img/clients/img4.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>Copyright © 2021 INVENTARIS LAB RPL</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <script src="{{assets('/Tenpurēto')}}assets/js/jquery-min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/popper.min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/bootstrap.min.js"></script>

    <script src="{{assets('/Tenpurēto')}}assets/js/wow.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/scrolling-nav.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/owl.carousel.min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/jquery.nav.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/jquery.easing.min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/jquery.slicknav.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/particles.min.js"></script>

    <script src="{{assets('/Tenpurēto')}}assets/js/main.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/form-validator.min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/contact-form-script.min.js"></script>
    <script src="{{assets('/Tenpurēto')}}assets/js/particlesjs.js"></script>
</body>
